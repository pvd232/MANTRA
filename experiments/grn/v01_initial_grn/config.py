...
class GRNResults:
    ...
    model_cfg: GRNModelConfig = field(default_factory=GRNModelConfig)
    train_cfg: GRNTrainConfig = field(default_factory=GRNTrainConfig)
    loss_cfg: GRNLossConfig = field(default_factory=GRNLossConfig)
